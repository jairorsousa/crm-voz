...
class OpportunityFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'title' => 'Projeto '.fake()->words(3, true),
            'estimated_value' => fake()->randomFloat(2, 5000, 250000),
            'probability' => fake()->numberBetween(10, 90),
            'expected_close_date' => fake()->dateTimeBetween('now', '+90 days')->format('Y-m-d'),
            'source' => fake()->randomElement(['Outbound', 'Inbound', 'Indicação', 'Evento']),
            'status' => OpportunityStatus::Open,
            'products_interests' => fake()->randomElement(['Cobrança ativa', 'Régua de cobrança', 'Recuperação de inadimplência']),
